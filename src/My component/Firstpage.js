  ...
  return (
    <div className="first-page">
      ...
      <div className="get_started d-flex justify-content-left py-5">
        <div className="sidelines" style={{ width: '90%', maxWidth: '600px' }}>
          <p
          ...
          >
            Your journey starts here—download the Easy Trip app now and unlock seamless bookings, personalized
            adventures, and exclusive travel deals. It's time to explore more, stress less.
          </p>

          <button className="btn btn-dark mt-3">Get Started</button>

          {/* Logos Section */}
          <div className="Logos d-flex align-items-center gap-3 mt-4">
            ...
            <div className="logo d-flex gap-3">
              ...
              >
                ...
                />
                <path
                  d="M345.8,174,89.22,32.64c-4.42-2.4-8.62,3.58-5,7.06L285.19,231.93Z"
                />
                <path
                  d="M84.08,472.39c-3.64,3.48.56,9.46,5,7.06L345.8,338l-60.61-57.95Z"
                />
                <path
